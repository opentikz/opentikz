...
- [ ] **P1 — Split the three content types into distinct tabs/sections, not one
      flat grid behind a tag filter.** Today all 16 items (9 icons · 5 templates ·
...
- [ ] **P1 — Surface the companion skill (the differentiator).** Template item
